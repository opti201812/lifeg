      ...
      const fetchBracelets = async () => {
         try {
            ...
            const formattedBracelets = allBracelets
               ...
               .filter((b: any) => b.assigned && b.armed); // 过滤出已分配的手环
   ...
   return (
      <div style={{ padding: 24 }}>
         ...
         {loading ? (
            ...
            <BraceletTable data={bracelets} loading={loading} actionType='armed' onAction={handleAction} />
         )}
